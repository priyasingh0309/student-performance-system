...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  $dob = $_POST["dob"];
  $accept_or_reject = $_POST["accept_or_reject"];
  $reason = isset($_POST["reason"]) ? $_POST["reason"] : "";

  // Process the form data as needed, e.g., save it to a database.

  // Example: Print a confirmation message
  if ($accept_or_reject === "accept") {
    echo "Congratulations, $student_name! Your application has been accepted.";
  } else {
    echo "Sorry, $student_name. Your application has been rejected. Reason: $reason";
  }
}